...
// Questions
var nodes = [
             { "node": 1, "message": "Please stay calm. Are you feeling lightheaded?", "yes": 2, "no": 2 },
             { "node": 2, "message": "Are you having trouble breathing?", "yes": 3, "no": 3 },
             { "node": 3, "message": "Are you bleeding uncontrollably?", "yes": 4, "no": 4 },
             { "node": 4, "message": "Have you been vomiting?", "yes": 5, "no": 5},
             { "node": 5, "message": "Have you been burned?", "yes": 6, "no": 7},
             { "node": 6, "message": "Run cool water over the burn for at least ten minutes. If it's a worrying color, please call 911.", "yes": 0, "no": 0},
             { "node": 7, "message": "Do you have a cut?", "yes": 8, "no": 9},
             { "node": 8, "message": "First things first, apply pressure to stop the bleeding. If the bleeding doesn't stop, please call 911. After the bleeding stops, wash with soap and water.", "yes": 0, "no": 0},
             { "node": 9, "message": "Do you think you broke a bone?", "yes": 10, "no": 11},
             { "node": 10, "message": "Follow the rice procedure. Rest the affected body part. Ice the wound for ten minutes at a time. Compress with gauze. Elevate affected body part above the heart. Please lie down if possible.", "yes": 0, "no": 0},
             { "node": 11, "message": "Get well soon", "yes": 0, "no": 0}
];
...
var welcomeMessage = "I'll try to walk you through basic first aid. Is that ok?";

// This is the message that is repeated if the response to the initial welcome message is not heard
var repeatWelcomeMessage = "Would you like first aid advice?";

// this is the message that is repeated if Alexa does not hear/understand the reponse to the welcome message
var promptToStartMessage = "Please answer the questions yes or no";

// This is the prompt during the game when Alexa doesnt hear or understand a yes / no reply
var promptToSayYesNo = "Say yes or no to answer the question, please.";

// This is the response to the user after the final question when Alex decides on what group choice the user should be given
var decisionMessage = "PLACEHOLDER Decision message";

// This is the prompt to ask the user if they would like to hear a short description of thier chosen profession or to play again
var playAgainMessage = "Play again message placeholder";

// this is the help message during the setup at the beginning of the game
var helpMessage = "I will ask you some questions that will help identify your problem.";

// This is the goodbye message when the user has asked to quit the game
var goodbyeMessage = "Goodbye";

var speechNotFoundMessage = "Error. Not Found";
