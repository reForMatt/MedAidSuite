var accountSid = 'AC76cb7c51d3936e02476dc85fc174b3b4';
var authToken = '15b3418b40bf319daf538d4556a453bd';
var fromNumber = '+14088728394';
...
function SendSMS(to, body, callback) {
    ...
    var req = https.request(options, function (res) {
        ...
        res.on('end', function () {
            ...
            var cardTitle = "Sent";
            var speechOutput = "Ok, emergency message sent.";
...
function onIntent(intentRequest, session, callback) {
    ...
    if("SendSms" === intentName){
        ...
        var text = "EMERGENCY FROM AJ. SEND HELP!"; //intentRequest.intent.slots.Text.value;
        console.log("Sending sms to : "+ destination + " with text: "+text);

        var number = "+15106760740";
...
function getWelcomeResponse(callback) {
    ...
    var speechOutput = "Would you like me to alert your emergency contact?";
    // If the user either does not reply to the welcome message or says something that is not
    // understood, they will be prompted again with this text.
    var repromptText = "Should I alert your emergency contact that you need help?";
